          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Detailed schedule and agenda for TNSCON 2026
              </p>
            </motion.div>
            ...
            >
              <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-12 shadow-lg border border-primary/10">
                <Calendar className="w-20 h-20 text-primary mx-auto mb-6 opacity-50" />
                <h2 className="text-3xl font-bold mb-4 text-foreground/80">Coming Soon</h2>
                <p className="text-lg text-foreground/60">
                  The detailed conference program will be updated soon. Stay tuned for the complete schedule and agenda.
                </p>
              </div>
            </motion.div>
          </div>
